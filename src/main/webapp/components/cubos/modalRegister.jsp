                ...
                <form name="formCubeRegister" id="formCubeRegister" novalidate ng-submit="registerCube()">
                    <div class="row gy-3">
                        <div class="col-12 col-md-6">
                            ...
                            <input required name="sku" type="text" class="form-control" ng-model="infoModal.sku">
                            <span class="invalid-feedback">{{validate('formCubeRegister', 'sku')}}</span>
                        </div>
                        <div class="col-12 col-md-6">
                            <label class="form-label">Nombre: <b>*</b></label>
                            <input required name="name" type="text" class="form-control" ng-model="infoModal.name">
                            <span class="invalid-feedback">{{validate('formCubeRegister', 'name')}}</span>
                        </div>
                        <div class="col-12">
                            <label class="form-label">Descripción: <b>*</b></label>
                            <input required name="description" type="text" class="form-control" ng-model="infoModal.description">
                            <span class="invalid-feedback">{{validate('formCubeRegister', 'description')}}</span>
                        </div>
                        <div class="col-12 col-md-6">
                            <label class="form-label">Imagen: <b>*</b></label>
                            <input required name="image" type="url" class="form-control" ng-model="infoModal.image">
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <input required name="image2" type="url" class="form-control" ng-model="infoModal.image2">
